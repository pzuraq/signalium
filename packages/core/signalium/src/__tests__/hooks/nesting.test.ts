...
describe('nesting', () => {
  ...
  permute(3, (create1, create2, create3) => {
    ...
    test('state + params two levels deep', async () => {
      ...
      // Flush all first
      expect(outer).withParams(1).toHaveValue(6);
      expect(outer).withParams(2).toHaveValue(9);
    ...
    test('params + state + multiple children', async () => {
      ...
      // Flush all first
      expect(outer).withParams(1, 2).toHaveValue(19);
      expect(outer).withParams(2, 2).toHaveValue(20);
      expect(outer).withParams(2, 3).toHaveValue(22);
      expect(outer).withParams(3, 3).toHaveValue(23);
    ...
    test('passing state as params + multiple children', async () => {
      ...
      expect(outer).withParams(1).toHaveValue(3);
      expect(outer).withParams(3).toHaveValue(11);
      ...
      await nextTick();
      expect(outer).withParams(1).toHaveValue(3);
      expect(outer).withParams(3).toHaveValue(14);
