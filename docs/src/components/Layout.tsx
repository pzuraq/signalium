  ...
  return (
    <header
      className={clsx(
        ...
        isScrolled
          ? 'dark:bg-indigo-950/95 dark:backdrop-blur-sm dark:[@supports(backdrop-filter:blur(0))]:bg-indigo-950/75'
          : 'dark:bg-transparent',
      )}
    >
      ...
      <div className="relative flex grow basis-0 items-center justify-center">
        <Link href="/" aria-label="Home page">
          ...
          />
          <Logo className="hidden h-16 w-auto fill-slate-700 lg:block dark:fill-sky-100" />
        </Link>
      </div>
    ...
    <div className="flex w-full flex-col">
      ...
      <div className="relative mx-auto flex w-full max-w-8xl flex-auto justify-center sm:px-2 lg:px-8 xl:px-12">
        <div className="hidden lg:relative lg:block lg:flex-none">
          <div className="absolute inset-y-0 right-0 w-[50vw] bg-indigo-100 dark:hidden" />
          <div className="absolute top-16 right-0 bottom-0 hidden h-12 w-px bg-linear-to-t from-slate-800 dark:block" />
          <div className="absolute top-28 right-0 bottom-0 hidden w-px bg-indigo-900 dark:block" />
